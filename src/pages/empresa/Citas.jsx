...
function TarjetaCita({ cita, onCambiarEstado, onAgregarComentario }) {
  return (
    <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl border border-gray-200 dark:border-gray-700 p-5 flex flex-col gap-3">
      ...
      {cita.anuncio_origen_detalle && (
        <div className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-purple-50 dark:bg-purple-950/40 border border-purple-200 dark:border-purple-800">
          ...
          <p className="text-xs text-purple-700 dark:text-purple-300 font-medium">
            Viene de la promo: {cita.anuncio_origen_detalle.titulo}
            {cita.anuncio_origen_detalle.descuento && (
              <span className="font-bold"> — {cita.anuncio_origen_detalle.descuento}</span>
            )}
          </p>
        </div>
      )}
